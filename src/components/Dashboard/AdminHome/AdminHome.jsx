...
const AdminHome = () => {
    ...
    return (
        <div>
            <h2 className='text-3xl font-semibold my-5 text-green-600'>Hi, Welcome - <span className='text-purple-600'>{user.displayName}</span></h2>
            ...
            <div className="stats shadow">
                ...
                <div className="stat">
                    ...
                    <div className="stat-value">${stats.revenueTotal}</div>
